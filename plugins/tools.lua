--Begin Tools.lua :)
local SUDO = 376151808 -- put Your ID here! <===
...
local text = matches[2]
tdcli.createNewChannelChat(text, 1, '@sudowolf', (function(b, d) tdcli.addChatMember(d.id_, msg.from.id, 0, dl_cb, nil) end), nil)
   if not lang then 
